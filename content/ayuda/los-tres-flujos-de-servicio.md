...
## 1. Solicitud de puesto nuevo

**Cuándo:** el puesto no existe en el catálogo. Nadie lo ha hecho nunca en ese comité.

Por ejemplo: el comité de audiovisuales nunca tuvo a alguien encargado de la transmisión en
vivo y ahora hace falta.

Se pide desde **Servidores → Puestos → Solicitar**, describiendo qué haría la persona. Lo que
...
**La ventana abre el día 25 de cada mes.** No es un capricho del sistema: es el ciclo con el
que se ordenan las aperturas. Fuera de esa ventana, la solicitud espera.
...
Entrar a un comité **sincroniza roles automáticamente**: según el puesto, el sistema le da los
accesos que necesita. Salir se los quita. Por eso no hay que pedir accesos aparte para el
líder de un comité — le llegan con el puesto.

## Qué pasa con la gente cuando algo se desactiva

Un puesto desactivado **no expulsa** a quien lo ocupa: la persona sigue registrada y aparece
listada para que la coordinación decida qué hacer. Los puestos con gente adentro no se borran,
se desactivan.

> Si tenés dudas de cuál pedir, preguntate qué es lo que falta: ¿la definición del puesto?
> ¿La plaza abierta? ¿O la persona? Esa respuesta te dice el flujo.
