...
export type StudyLeader = {
  ...
  availability_status: 'available' | 'assigned' | 'resting'
  is_active: boolean
...
export const STUDY_TYPES: StudyType[] = [
  ...
  // ETAPA INICIAL
  {
    id: 'SCJ', code: 'SCJ', name: 'Sirviendo como Jesús', stage: 'inicial', weeks: 10,
    prerequisite: 'N4', requires_payment: true, cost: 15000,
    requires_grade: false, auto_promote: false, next_study_id: 'DIS1',
    req_donor: true, req_server: false, req_attendee: false, is_archived: false,
  },
  {
    id: 'ASF', code: 'ASF', name: 'Amor sin Fronteras', stage: 'inicial', weeks: 10,
    prerequisite: 'N4', requires_payment: true, cost: 15000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: false, req_attendee: false, is_archived: false,
  },
  {
    id: 'EVM', code: 'EVM', name: 'Evangelismo', stage: 'inicial', weeks: 8,
    prerequisite: 'N4', requires_payment: true, cost: 15000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: false, req_attendee: false, is_archived: false,
  },
  ...
  {
    id: 'MAT', code: 'MAT', name: 'Matrimonios', stage: 'inicial', weeks: 11,
    prerequisite: 'N4', requires_payment: true, cost: 15000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: false, req_attendee: false, is_archived: false,
  },
  ...
  {
    id: 'CTBD', code: 'CTBD', name: 'Cómo Tomar Buenas Decisiones', stage: 'intermedia', weeks: 10,
    prerequisite: 'DIS3', requires_payment: true, cost: 20000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: true, req_attendee: true, is_archived: false,
  },
  {
    id: 'PAN', code: 'PAN', name: 'Panorama', stage: 'intermedia', weeks: 10,
    prerequisite: 'DIS3', requires_payment: true, cost: 20000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: true, req_attendee: true, is_archived: false,
  },
  ...
  {
    id: 'HCH', code: 'HCH', name: 'Hechos', stage: 'intermedia', weeks: 8,
    prerequisite: 'PAN', requires_payment: true, cost: 20000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: true, req_attendee: true, is_archived: false,
  },
  {
    id: 'ROM', code: 'ROM', name: 'Romanos', stage: 'intermedia', weeks: 8,
    prerequisite: 'PAN', requires_payment: true, cost: 20000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: true, req_attendee: true, is_archived: false,
  },
  {
    id: 'HEB', code: 'HEB', name: 'Hebreos', stage: 'intermedia', weeks: 8,
    prerequisite: 'PAN', requires_payment: true, cost: 20000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: true, req_attendee: true, is_archived: false,
  },
  {
    id: 'RDM', code: 'RDM', name: 'Religiones del Mundo', stage: 'intermedia', weeks: 8,
    prerequisite: 'PAN', requires_payment: true, cost: 20000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: true, req_attendee: true, is_archived: false,
  },
  {
    id: 'DLF', code: 'DLF', name: 'Defendiendo la Fe', stage: 'intermedia', weeks: 8,
    prerequisite: 'PAN', requires_payment: true, cost: 20000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: true, req_server: true, req_attendee: true, is_archived: false,
  },
  ...
  {
    id: 'TPS23', code: 'TPS23', name: 'Tiempo para Soñar',      stage: 'campaña', weeks: 8,
    prerequisite: null, requires_payment: true, cost: 25000,
    requires_grade: false, auto_promote: false, next_study_id: null,
    req_donor: false, req_server: false, req_attendee: false, is_archived: false,
  },
...
export const MOCK_WAIT_LIST: WaitListEntry[] = [
  ...
  { id: 'wl-022', member_id: 'wl-m-022', member_name: 'Mauricio Conejo', age: 32, zone_preference: 'pedregal', horario_preference: 'Jueves 7:30pm', requested_at: '2025-02-15', type: 'campaign', campaign_code: 'TPS23' },
