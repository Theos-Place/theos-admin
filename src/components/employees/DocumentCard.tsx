    ...
    >
      ...
      <div className="flex items-center gap-1 shrink-0">
        <a
          ...
          className="h-8 w-8 rounded-lg flex items-center justify-center text-navy-light/80 hover:text-navy hover:bg-surface-low transition-colors"
        >
        ...
        {onDelete && (
          <button
            ...
            className="h-8 w-8 rounded-lg flex items-center justify-center text-navy-light/80 hover:text-coral hover:bg-coral/10 transition-colors"
          >
            <Trash2 size={14} />
          </button>
        )}
