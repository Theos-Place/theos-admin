    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        {step === 1 ? (
          <>
            {/* Header rojo */}
            <div className="bg-coral/10 border-b px-5 py-4 flex items-center gap-3" style={{ borderColor: 'var(--outline-variant)' }}>
              ...
              <div>
                ...
                <p className="text-[11px] text-navy-light/60" style={{ fontFamily: 'var(--font-body)' }}>
            ...
            <div className="p-5 space-y-4">
              <div className="rounded-xl bg-coral/5 border border-coral/20 px-4 py-3">
                <p className="text-sm text-coral font-medium" style={{ fontFamily: 'var(--font-body)' }}>
                  {eventName}
                </p>
              </div>
              ...
              <div className="flex gap-2 pt-1">
                <button
                  ...
                  disabled={!canConfirm}
                  className="flex-1 rounded-full bg-coral px-5 py-2.5 text-sm text-white hover:bg-coral-deep transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                  style={{ fontFamily: 'var(--font-body)' }}
                >
                  Cancelar evento
                </button>
                <button
                  onClick={onClose}
                  className="rounded-full border px-5 py-2.5 text-sm text-navy-light hover:bg-surface-low transition-all"
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="font-semibold text-navy" style={{ fontFamily: 'var(--font-display)' }}>
