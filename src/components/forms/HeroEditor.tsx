          ...
          {value.hero_image_url ? (
            ...
            <button
              ...
              className={cn(
                ...
                'border-[var(--outline-variant)] text-navy-light/70 hover:bg-surface-low disabled:opacity-50',
              )}
            >
              {subiendo
                ? <><Loader2 size={18} className="animate-spin" /><span className="text-[12px] font-body">Subiendo…</span></>
                : <>
                    <ImagePlus size={18} />
