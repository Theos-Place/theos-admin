  ...
  return (
    <div className="rounded-2xl overflow-hidden border border-[var(--outline-variant)] bg-white">
      ...
      <div className="px-4 py-2 border-b flex items-center gap-2 border-[#e0e0e0] bg-[#f8f8f8]">
        ...
        <span className="ml-2 text-[13px] text-gray-600 font-body">Vista previa de correo</span>
      </div>

      {/* Email meta */}
      <div className="px-5 py-4 border-b space-y-1.5 border-[#e0e0e0]">
        <div className="flex items-baseline gap-2">
          <span className="text-[11px] uppercase tracking-widest text-gray-600 w-14 shrink-0 font-display">De</span>
          <span className="text-[13px] text-gray-700 font-body">{fromName} &lt;no-reply@theosplace.org&gt;</span>
        </div>
        <div className="flex items-baseline gap-2">
          <span className="text-[11px] uppercase tracking-widest text-gray-600 w-14 shrink-0 font-display">Para</span>
          <span className="text-[13px] text-gray-700 font-body">{previewName} Rodríguez &lt;maria@ejemplo.com&gt;</span>
        </div>
        <div className="flex items-baseline gap-2">
          <span className="text-[11px] uppercase tracking-widest text-gray-600 w-14 shrink-0 font-display">Asunto</span>
          <span className="text-[13px] font-semibold text-gray-800 font-body">{hydratedSubject || '(sin asunto)'}</span>
        </div>
      </div>
      ...
      {format === 'html' ? (
        ...
        <div className="px-5 py-5">
          ...
          <div className="mt-6 pt-4 border-t text-center border-[#f0f0f0]">
            <p className="text-[13px] text-gray-600 font-body">Theos Place · theosplace.org</p>
          </div>
        </div>
      )}
    </div>
