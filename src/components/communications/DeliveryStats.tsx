        ...
        {cards.map(card => {
          ...
          return (
            <div key={card.key} className="rounded-2xl p-4 bg-surface-card shadow-[var(--shadow-md)]">
              ...
              <p className="text-[11px] uppercase tracking-widest text-navy-light/70 mb-1 font-display">
                {card.label}
              </p>
              ...
              {card.hint && (
                <p className="mt-1 text-[11px] text-navy-light/70 font-body leading-snug">{card.hint}</p>
              )}
            </div>
          )
        })}
        ...
        <div className="rounded-2xl p-5 space-y-3 bg-surface-card shadow-[var(--shadow-md)]">
          ...
          <div className="space-y-2.5">
            <div className="flex items-center gap-3">
              <span className="text-[12px] text-navy-light/70 w-20 shrink-0 font-body">
              ...
              <span className="text-[12px] font-mono text-navy tabular-nums w-10 text-right">
                {rate ?? sentRate}%
              </span>
            </div>
            <div className="flex items-center gap-3">
              <span className="text-[12px] text-navy-light/70 w-20 shrink-0 font-body">Fallidos</span>
              <div className="flex-1 h-2 rounded-full bg-navy/10">
            ...
            {message.channel === 'both' && (
              <>
                <div className="flex items-center gap-3">
                  <span className="text-[12px] text-navy-light/70 w-20 shrink-0 font-body">WhatsApp</span>
                  <div className="flex-1 h-2 rounded-full bg-navy/10">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-[12px] text-navy-light/70 w-20 shrink-0 font-body">Email</span>
                  <div className="flex-1 h-2 rounded-full bg-navy/10">
