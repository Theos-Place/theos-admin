        ...
        {cards.map(card => {
          ...
          return (
            <div key={card.key} className="rounded-2xl p-4 bg-surface-card shadow-[var(--shadow-md)]">
              ...
              <p className="text-[10px] uppercase tracking-widest text-navy-light/70 mb-1 font-display">
                {card.label}
              </p>
              ...
              {card.hint && (
                <p className="mt-1 text-[10px] text-navy-light/70 font-body leading-snug">{card.hint}</p>
              )}
            </div>
          )
        })}
        ...
        <div className="rounded-2xl p-5 space-y-3 bg-surface-card shadow-[var(--shadow-md)]">
          ...
          <div className="space-y-2.5">
            <div className="flex items-center gap-3">
              <span className="text-[11px] text-navy-light/70 w-20 shrink-0 font-body">
