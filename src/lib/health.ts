 ...
 */
export async function pingHealthcheck(envKey: 'HEALTHCHECK_URL_FOLLETO_BLOCKS' | 'HEALTHCHECK_URL_START_REMINDERS' | 'HEALTHCHECK_URL_LEADER_ABSENCE' | 'HEALTHCHECK_URL_STORAGE_ORPHANS' | 'HEALTHCHECK_URL_PAYMENT_HOLDS_EXPIRE' | 'HEALTHCHECK_URL_GROUP_WINDOWS'): Promise<void> {
