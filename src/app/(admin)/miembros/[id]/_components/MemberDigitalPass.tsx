    ...
    <div className="rounded-2xl bg-surface-card p-5 shadow-[var(--shadow-md)]">
      ...
      <div className="flex flex-col items-center gap-5">
        ...
        <div className="w-full max-w-xs rounded-2xl bg-navy p-6 shadow-[var(--shadow-md)]">
          ...
          <p className="text-white/60 text-sm mb-5 font-display font-extrabold">{member.last_name}</p>
        ...
        <div className="w-full max-w-xs space-y-3">
          ...
          <div className="flex flex-col gap-2 pt-1">
            ...
            >
              ...
              <span className="text-[10px] uppercase tracking-wide bg-surface-low text-navy-light/50 rounded-full px-1.5 py-0.5">Próximamente</span>
            </button>
            <button
              type="button"
              disabled
