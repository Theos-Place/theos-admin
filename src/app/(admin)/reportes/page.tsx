...
import { BarChart2, ChevronRight, type LucideIcon } from 'lucide-react'
        ...
        {REPORTS.filter(r => r.ready).map(r => {
          ...
          return (
            ...
            >
              ...
              <p className="mt-1 text-[13px] text-navy-light/60 font-body leading-relaxed">{r.description}</p>
            </Link>
          )
        })}
      </div>
