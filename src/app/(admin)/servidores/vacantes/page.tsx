    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <div className="flex items-center gap-2 rounded-xl bg-surface-card px-3 py-2 shadow-[var(--shadow-sm)]">
          <Search size={16} className="text-navy-light/80 shrink-0" aria-hidden />
          <input
            value={qPuesto}
      ...
      <div className="space-y-3">
        {loading ? (
          <div className="flex flex-col items-center gap-3 py-16 text-navy-light/80">
            ...
            <div key={g.id} className="rounded-2xl bg-surface-card shadow-[var(--shadow-md)] overflow-hidden">
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="mt-0.5 flex items-center gap-3 text-[13px] text-navy-light/80 font-body">
                    ...
                    return (
                      <div key={v.id} className="p-5 space-y-3">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <span className="shrink-0 rounded-full bg-surface-low px-2.5 py-1 text-[13px] text-navy-light/80 font-body">
