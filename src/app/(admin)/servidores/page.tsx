    ...
    >
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        {committee.open_vacancies > 0 && (
          <span
            className="shrink-0 rounded-full bg-coral/10 px-2 py-0.5 text-[10px] font-semibold text-coral font-display"
          >
      ...
      <div className="flex items-center gap-2">
        <div className="h-6 w-6 rounded-full bg-navy/10 flex items-center justify-center shrink-0">
          <span className="text-[9px] font-bold text-navy font-display">
            {committee.leader.initials}
          </span>
        </div>
        <p className="text-[12px] text-navy-light/60 truncate font-body">
        ...
        <div className="flex -space-x-1.5">
          ...
          {activeMembers.length > 4 && (
            <div className="h-7 w-7 rounded-full bg-surface-low flex items-center justify-center ring-2 ring-white">
              <span className="text-[9px] font-medium text-navy-light/60 font-display">
                +{activeMembers.length - 4}
              </span>
            </div>
          )}
