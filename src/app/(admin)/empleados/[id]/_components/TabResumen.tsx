    ...
    <div className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="rounded-xl p-4 space-y-1 bg-surface-low">
          <p className="text-[10px] uppercase tracking-widests text-navy-light/40 font-display">Salario actual</p>
          <SalaryBadge amount={employee.current_salary} size="md" />
        </div>
        <div className="rounded-xl p-4 space-y-1 bg-surface-low">
          <p className="text-[10px] uppercase tracking-widests text-navy-light/40 font-display">Tipo de contrato</p>
          <ContractTypeBadge type={employee.contract_type} size="md" />
        </div>
        <div className="rounded-xl p-4 space-y-1 bg-surface-low">
          <p className="text-[10px] uppercase tracking-widests text-navy-light/40 font-display">Vacaciones</p>
      ...
      {employee.notes && (
        <div>
          <p className="text-[10px] uppercase tracking-widests text-navy-light/40 mb-2 font-display">Notas internas</p>
