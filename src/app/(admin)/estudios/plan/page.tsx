  ...
  return (
    ...
    >
        ...
        <div>
          <div className="flex items-center gap-1.5">
            <span
              ...
              className="font-display text-[11px] font-bold tracking-[.08em] uppercase"
            >
              {study.code}
            </span>
            {study.is_archived && (
      ...
      {(() => {
        ...
        return t ? (
          <div className="mt-2">
            <span className={cn('text-[11px] py-0.5 px-2 rounded-full font-semibold font-display', t.cls)}>{t.label}</span>
          </div>
        ) : null
      })()}
