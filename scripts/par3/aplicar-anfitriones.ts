/**
 * PAR-3 · Le aplica el rol de REPORTES a quienes ya tienen el puesto
 * "Anfitrión" en un comité de sede (decisión del usuario, 2026-09-23).
 *
 * Hace falta un script porque `position-role-sync` corre al ASIGNAR un puesto,
 * no al cambiar la regla: las 21 personas que ya lo tienen no lo reciben solas.
 ...
 *   NODE_OPTIONS="--conditions=react-server" npx tsx scripts/par3/aplicar-anfitriones.ts
 *   NODE_OPTIONS="--conditions=react-server" npx tsx scripts/par3/aplicar-anfitriones.ts --aplicar
 */
