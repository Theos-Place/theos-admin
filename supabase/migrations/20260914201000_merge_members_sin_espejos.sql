-- merge_members deja de copiar los espejos. Ver 20260914200000 y la función
-- merge_no_copia(): la lista de exclusión pasa a estar en un solo lugar para
-- que merge_members y merge_members_resuelto no se separen.
--
-- El caso: a Ximena Solórzano el coalesce le copió last_sign_in_at del
-- duplicado, y la ficha quedó diciendo que entró el 8 de setiembre cuando la
-- cuenta a la que apunta nunca se usó.
