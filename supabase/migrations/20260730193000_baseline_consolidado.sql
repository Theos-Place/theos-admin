-- ─────────────────────────────────────────────────────────────────────────────
-- BASELINE CONSOLIDADO · 2026-07-30 (MNT-1)
--
-- Volcado del esquema COMPLETO de producción (tablas, CHECKs, índices, vistas,
-- funciones, triggers, RLS con sus policies y grants). Reemplaza al baseline
-- anterior (20260718150236) y a las 32 migraciones que vinieron después: todas
-- quedaron en `supabase/migrations_archive/` — son historia, no se borran.
--
-- Generado con: npx supabase db dump --db-url <session pooler de producción>
--
-- NO ESTÁ ACÁ (y hay que crearlo a mano en un proyecto nuevo):
--   · Buckets de Storage (se crean por dashboard, no viven en migraciones):
--       payment-receipts · employee-docs · email-images
--   · Los crons: viven en vercel.json (no en pg_cron) + la edge function
--     supabase/functions/process-email-queue.
--   · Las variables de entorno (SES, Supabase, healthchecks, Sentry).
-- ─────────────────────────────────────────────────────────────────────────────
...
CREATE OR REPLACE FUNCTION "public"."get_active_today"("p_oldest" timestamp with time zone, "p_min" integer) RETURNS TABLE("member_id" "uuid")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select ec.member_id
...
ALTER FUNCTION "public"."get_active_today"("p_oldest" timestamp with time zone, "p_min" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_dm_flags"("p_oldest" timestamp with time zone, "p_recency" timestamp with time zone, "p_min" integer) RETURNS TABLE("person_id" "uuid", "es_comprometido" boolean, "sirve" boolean, "dona" boolean, "es_dm" boolean, "cohort_year" integer)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with charla as (
...
ALTER FUNCTION "public"."get_dm_flags"("p_oldest" timestamp with time zone, "p_recency" timestamp with time zone, "p_min" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_dm_milestones"("p_min" integer) RETURNS TABLE("milestone" "text", "avg_days" numeric, "n" integer)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with charla as (
...
ALTER FUNCTION "public"."get_dm_milestones"("p_min" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_group_attendance"() RETURNS TABLE("person_id" "uuid", "yr" integer, "grp" "text", "visits" integer, "max_age" integer)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with charla as (
...
ALTER FUNCTION "public"."get_group_attendance"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."refresh_member_sede"("p_member_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."cdeb_recommendations" (
    ...
    "testimony_score" "text",
    "testimony_notes" "text",
    "passion_score" "text",
    "passion_notes" "text",
    "bible_knowledge_score" "text",
    "speech_score" "text",
    "speech_notes" "text",
    ...
    CONSTRAINT "cdeb_recommendations_bible_knowledge_score_check" CHECK ((("bible_knowledge_score" IS NULL) OR ("bible_knowledge_score" = ANY (ARRAY['1'::"text", '2'::"text", '3'::"text", '4'::"text", '5'::"text"])))),
    CONSTRAINT "cdeb_recommendations_passion_score_check" CHECK ((("passion_score" IS NULL) OR ("passion_score" = ANY (ARRAY['1'::"text", '2'::"text", '3'::"text", '4'::"text", '5'::"text", 'x'::"text"])))),
    CONSTRAINT "cdeb_recommendations_recommendation_check" CHECK ((("recommendation" IS NULL) OR ("recommendation" = ANY (ARRAY['si_sin_reservas'::"text", 'si_otro_estudio'::"text", 'si_con_reservas'::"text", 'no'::"text"])))),
    CONSTRAINT "cdeb_recommendations_speech_score_check" CHECK ((("speech_score" IS NULL) OR ("speech_score" = ANY (ARRAY['1'::"text", '2'::"text", '3'::"text", '4'::"text", '5'::"text"])))),
    CONSTRAINT "cdeb_recommendations_status_check" CHECK (("status" = ANY (ARRAY['borrador'::"text", 'enviada'::"text"]))),
    CONSTRAINT "cdeb_recommendations_testimony_score_check" CHECK ((("testimony_score" IS NULL) OR ("testimony_score" = ANY (ARRAY['1'::"text", '2'::"text", '3'::"text", '4'::"text", '5'::"text", 'x'::"text"]))))
);


ALTER TABLE "public"."cdeb_recommendations" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."folleto_requests" (
    ...
    CONSTRAINT "folleto_requests_tipo_check" CHECK (("tipo" = ANY (ARRAY['cierre'::"text", 'preapertura_preliminar'::"text", 'preapertura_confirmacion'::"text", 'preapertura_final'::"text", 'reubicacion'::"text", 'manual'::"text", 'cupo_lleno'::"text", 'fin_matricula'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."form_fields" (
    ...
    "options_source" "text",
    "options_source_param" "text",
    CONSTRAINT "form_fields_field_type_check" CHECK (("field_type" = ANY (ARRAY['text'::"text", 'textarea'::"text", 'number'::"text", 'email'::"text", 'phone'::"text", 'date'::"text", 'select'::"text", 'multiselect'::"text", 'checkbox'::"text", 'radio'::"text", 'scale'::"text", 'file'::"text", 'personal_data'::"text", 'section_header'::"text", 'yes_no'::"text", 'section'::"text", 'page_break'::"text", 'info'::"text"]))),
    CONSTRAINT "form_fields_options_source_check" CHECK ((("options_source" IS NULL) OR ("options_source" = 'study_groups_open'::"text")))
);
...
COMMENT ON COLUMN "public"."form_fields"."options_source" IS 'EST-10: si está seteado, las opciones se resuelven en el servidor al abrir el formulario (options_source_param lleva el filtro, p. ej. el code del plan).';



CREATE TABLE IF NOT EXISTS "public"."form_response_reviews" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "form_response_reviews_status_check" CHECK (("status" = ANY (ARRAY['pendiente'::"text", 'aprobado'::"text", 'lista_espera'::"text", 'rechazado'::"text"])))
);


ALTER TABLE "public"."form_response_reviews" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."member_roles" (
    ...
    CONSTRAINT "member_roles_role_check" CHECK (("role" = ANY (ARRAY['admin'::"text", 'direccion'::"text", 'finanzas'::"text", 'encargado_staff'::"text", 'coordinador_servidores'::"text", 'coordinador_estudios'::"text", 'coordinador_dirigentes'::"text", 'encargado_eventos'::"text", 'lider_comite'::"text", 'comunicaciones'::"text", 'dirigente'::"text", 'editor_perfiles'::"text", 'miembro'::"text", 'solo_lectura'::"text", 'reportes'::"text", 'folletos'::"text", 'becas'::"text", 'revision_pagos'::"text", 'editor_grupos_estudio'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."members" (
    ...
    CONSTRAINT "members_document_type_check" CHECK (("document_type" = ANY (ARRAY['cedula'::"text", 'dni_nie'::"text", 'pasaporte'::"text", 'otro'::"text"]))),
...
COMMENT ON COLUMN "public"."members"."cedula" IS 'Número del documento de identidad (del tipo en document_type). Para CR es la cédula; cedula_normalized lo normaliza para dedup.';
...
CREATE TABLE IF NOT EXISTS "public"."payments" (
    ...
    CONSTRAINT "payments_concept_check" CHECK ((("concept" IS NULL) OR ("concept" = ANY (ARRAY['matricula'::"text", 'folletos'::"text", 'evento'::"text", 'prematrimonial'::"text"])))),
    CONSTRAINT "payments_currency_check" CHECK (("currency" = ANY (ARRAY['CRC'::"text", 'USD'::"text", 'EUR'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."prematrimonial_evaluations" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "request_id" "uuid" NOT NULL,
    "group_id" "uuid" NOT NULL,
    ...
    "topics_to_work" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "observations" "text",
    "blind_spot" boolean DEFAULT false NOT NULL,
    "blind_spot_notes" "text",
    "action_plan" "text" NOT NULL,
    "blessing" "text",
    "filled_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "prematrimonial_evaluations_action_plan_check" CHECK (("action_plan" = ANY (ARRAY['listos'::"text", 'consejeria'::"text", 'posponer'::"text"]))),
    CONSTRAINT "prematrimonial_evaluations_commitment_check" CHECK (("commitment" = ANY (ARRAY['si'::"text", 'en_proceso'::"text", 'requiere_atencion'::"text"])))
);


ALTER TABLE "public"."prematrimonial_evaluations" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."prematrimonial_request_status_history" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "request_id" "uuid" NOT NULL,
    "from_status" "text",
    "to_status" "text" NOT NULL,
...
ALTER TABLE "public"."prematrimonial_request_status_history" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."prematrimonial_requests" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "requester_member_id" "uuid" NOT NULL,
    "spouse_member_id" "uuid" NOT NULL,
    "status" "text" DEFAULT 'pago_en_revision'::"text" NOT NULL,
    "available_days" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "available_times" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "zones" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "can_host" boolean DEFAULT false NOT NULL,
    "host_address" "text",
    "host_maps_url" "text",
    "ceremony_date" "date",
    "ceremony_date_defined" boolean DEFAULT false NOT NULL,
    "venue_defined" boolean DEFAULT false NOT NULL,
    "venue_outside_gam" boolean DEFAULT false NOT NULL,
    "officiant" "text",
    "comments" "text",
    "payment_id" "uuid",
    ...
    "previous_marriage_notes" "text",
    "has_children" boolean,
    "children_ages" "text",
    "living_arrangement" "text",
    "diagnostic_notes" "text",
    CONSTRAINT "premat_distinct_pair" CHECK (("requester_member_id" <> "spouse_member_id")),
    CONSTRAINT "prematrimonial_requests_dating_time_check" CHECK ((("dating_time" IS NULL) OR ("dating_time" = ANY (ARRAY['menos_1'::"text", '1_2'::"text", '3_4'::"text", 'mas_4'::"text"])))),
    CONSTRAINT "prematrimonial_requests_living_arrangement_check" CHECK ((("living_arrangement" IS NULL) OR ("living_arrangement" = ANY (ARRAY['separadas'::"text", 'convivimos'::"text"])))),
    CONSTRAINT "prematrimonial_requests_status_check" CHECK (("status" = ANY (ARRAY['pago_en_revision'::"text", 'pendiente'::"text", 'grupo_creado'::"text", 'cancelada'::"text"])))
);


ALTER TABLE "public"."prematrimonial_requests" OWNER TO "postgres";


COMMENT ON COLUMN "public"."prematrimonial_requests"."previous_marriage_notes" IS 'PRE-9 SENSIBLE (pastoral): solo coordinador_estudios/direccion/admin — el API recorta este campo para otros roles.';



COMMENT ON COLUMN "public"."prematrimonial_requests"."diagnostic_notes" IS 'PRE-9 SENSIBLE (pastoral): solo coordinador_estudios/direccion/admin — el API recorta este campo para otros roles.';
...
COMMENT ON TABLE "public"."report_snapshots" IS 'Caché de datasets de reportes, refrescada por el cron /api/cron/report-snapshots. report_key = dataset (dm_flags, dm_milestones, group_attendance, charla_attendance, member_growth).';
...
CREATE TABLE IF NOT EXISTS "public"."study_plans" (
    ...
    CONSTRAINT "study_plans_level_check" CHECK (("level" = ANY (ARRAY['niveles'::"text", 'etapa_inicial'::"text", 'etapa_intermedia'::"text", 'etapa_avanzada'::"text", 'campanas'::"text", 'externa'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."study_requests" (
    ...
    "proposed_days" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "proposed_time" "text",
    "was_eligible" boolean,
    "eligibility_note" "text",
    "proposed_zones" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    ...
    CONSTRAINT "study_requests_proposed_time_check" CHECK ((("proposed_time" IS NULL) OR ("proposed_time" = ANY (ARRAY['mañana'::"text", 'tarde'::"text", 'noche'::"text"])))),
...
CREATE TABLE IF NOT EXISTS "public"."vacancies" (
    ...
    CONSTRAINT "vacancies_status_check" CHECK (("status" = ANY (ARRAY['creado'::"text", 'enviado_lider'::"text", 'aprobado'::"text", 'denegado'::"text", 'cerrada'::"text"])))
);
...
ALTER TABLE ONLY "public"."cdeb_recommendations"
    ADD CONSTRAINT "cdeb_rec_member_group_uniq" UNIQUE ("member_id", "group_id");



ALTER TABLE ONLY "public"."cdeb_recommendations"
    ADD CONSTRAINT "cdeb_recommendations_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."form_response_reviews"
    ADD CONSTRAINT "form_response_reviews_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."form_response_reviews"
    ADD CONSTRAINT "form_response_reviews_response_uniq" UNIQUE ("response_id");
...
ALTER TABLE ONLY "public"."prematrimonial_evaluations"
    ADD CONSTRAINT "premat_eval_request_uniq" UNIQUE ("request_id");



ALTER TABLE ONLY "public"."prematrimonial_evaluations"
    ADD CONSTRAINT "prematrimonial_evaluations_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."prematrimonial_request_status_history"
    ADD CONSTRAINT "prematrimonial_request_status_history_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."prematrimonial_requests"
    ADD CONSTRAINT "prematrimonial_requests_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."report_snapshots"
    ADD CONSTRAINT "report_snapshots_pkey" PRIMARY KEY ("report_key");
...
CREATE UNIQUE INDEX "folleto_requests_auto_por_grupo" ON "public"."folleto_requests" USING "btree" ("source_group_id") WHERE ("tipo" = ANY (ARRAY['cupo_lleno'::"text", 'fin_matricula'::"text"]));
...
CREATE INDEX "idx_cdeb_rec_enviadas" ON "public"."cdeb_recommendations" USING "btree" ("created_at" DESC) WHERE ("status" = 'enviada'::"text");



CREATE INDEX "idx_cdeb_rec_group" ON "public"."cdeb_recommendations" USING "btree" ("group_id");



CREATE INDEX "idx_cdeb_rec_member" ON "public"."cdeb_recommendations" USING "btree" ("member_id");
...
CREATE INDEX "idx_form_response_reviews_form" ON "public"."form_response_reviews" USING "btree" ("form_id");



CREATE INDEX "idx_form_response_reviews_por_invitar" ON "public"."form_response_reviews" USING "btree" ("form_id") WHERE (("status" = 'aprobado'::"text") AND ("invited_at" IS NULL));
...
CREATE INDEX "idx_premat_eval_group" ON "public"."prematrimonial_evaluations" USING "btree" ("group_id");



CREATE INDEX "idx_premat_hist_request" ON "public"."prematrimonial_request_status_history" USING "btree" ("request_id");



CREATE INDEX "idx_premat_payment" ON "public"."prematrimonial_requests" USING "btree" ("payment_id");



CREATE INDEX "idx_premat_requester" ON "public"."prematrimonial_requests" USING "btree" ("requester_member_id");



CREATE INDEX "idx_premat_spouse" ON "public"."prematrimonial_requests" USING "btree" ("spouse_member_id");



CREATE INDEX "idx_premat_status" ON "public"."prematrimonial_requests" USING "btree" ("status");
...
CREATE UNIQUE INDEX "members_document_norm_uniq" ON "public"."members" USING "btree" ("document_type", "cedula_normalized") WHERE (("cedula_normalized" IS NOT NULL) AND (NOT "cedula_dup_legacy"));
...
CREATE UNIQUE INDEX "premat_active_pair_uniq" ON "public"."prematrimonial_requests" USING "btree" ("requester_member_id", "spouse_member_id") WHERE ("status" = ANY (ARRAY['pago_en_revision'::"text", 'pendiente'::"text"]));
...
CREATE OR REPLACE TRIGGER "set_updated_at_cdeb_rec" BEFORE UPDATE ON "public"."cdeb_recommendations" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "set_updated_at_form_response_reviews" BEFORE UPDATE ON "public"."form_response_reviews" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "set_updated_at_premat" BEFORE UPDATE ON "public"."prematrimonial_requests" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
ALTER TABLE ONLY "public"."cdeb_recommendations"
    ADD CONSTRAINT "cdeb_recommendations_enrollment_id_fkey" FOREIGN KEY ("enrollment_id") REFERENCES "public"."study_enrollments"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."cdeb_recommendations"
    ADD CONSTRAINT "cdeb_recommendations_filled_by_fkey" FOREIGN KEY ("filled_by") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."cdeb_recommendations"
    ADD CONSTRAINT "cdeb_recommendations_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "public"."study_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."cdeb_recommendations"
    ADD CONSTRAINT "cdeb_recommendations_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "public"."members"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."folleto_requests"
    ADD CONSTRAINT "folleto_requests_target_leader_id_fkey" FOREIGN KEY ("target_leader_id") REFERENCES "public"."members"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."form_response_reviews"
    ADD CONSTRAINT "form_response_reviews_broadcast_id_fkey" FOREIGN KEY ("broadcast_id") REFERENCES "public"."message_broadcasts"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."form_response_reviews"
    ADD CONSTRAINT "form_response_reviews_form_id_fkey" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."form_response_reviews"
    ADD CONSTRAINT "form_response_reviews_invitation_id_fkey" FOREIGN KEY ("invitation_id") REFERENCES "public"."study_invitations"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."form_response_reviews"
    ADD CONSTRAINT "form_response_reviews_response_id_fkey" FOREIGN KEY ("response_id") REFERENCES "public"."form_responses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."form_response_reviews"
    ADD CONSTRAINT "form_response_reviews_reviewed_by_fkey" FOREIGN KEY ("reviewed_by") REFERENCES "public"."members"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."prematrimonial_evaluations"
    ADD CONSTRAINT "prematrimonial_evaluations_filled_by_fkey" FOREIGN KEY ("filled_by") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prematrimonial_evaluations"
    ADD CONSTRAINT "prematrimonial_evaluations_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "public"."study_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."prematrimonial_evaluations"
    ADD CONSTRAINT "prematrimonial_evaluations_request_id_fkey" FOREIGN KEY ("request_id") REFERENCES "public"."prematrimonial_requests"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."prematrimonial_request_status_history"
    ADD CONSTRAINT "prematrimonial_request_status_history_changed_by_fkey" FOREIGN KEY ("changed_by") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prematrimonial_request_status_history"
    ADD CONSTRAINT "prematrimonial_request_status_history_request_id_fkey" FOREIGN KEY ("request_id") REFERENCES "public"."prematrimonial_requests"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."prematrimonial_requests"
    ADD CONSTRAINT "prematrimonial_requests_canceled_by_fkey" FOREIGN KEY ("canceled_by") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prematrimonial_requests"
    ADD CONSTRAINT "prematrimonial_requests_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prematrimonial_requests"
    ADD CONSTRAINT "prematrimonial_requests_payment_id_fkey" FOREIGN KEY ("payment_id") REFERENCES "public"."payments"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prematrimonial_requests"
    ADD CONSTRAINT "prematrimonial_requests_refund_request_id_fkey" FOREIGN KEY ("refund_request_id") REFERENCES "public"."finance_requests"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prematrimonial_requests"
    ADD CONSTRAINT "prematrimonial_requests_requester_member_id_fkey" FOREIGN KEY ("requester_member_id") REFERENCES "public"."members"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."prematrimonial_requests"
    ADD CONSTRAINT "prematrimonial_requests_resulting_group_id_fkey" FOREIGN KEY ("resulting_group_id") REFERENCES "public"."study_groups"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prematrimonial_requests"
    ADD CONSTRAINT "prematrimonial_requests_reviewed_by_fkey" FOREIGN KEY ("reviewed_by") REFERENCES "public"."members"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."prematrimonial_requests"
    ADD CONSTRAINT "prematrimonial_requests_spouse_member_id_fkey" FOREIGN KEY ("spouse_member_id") REFERENCES "public"."members"("id") ON DELETE CASCADE;
...
CREATE POLICY "capacitacion_bloques_all" ON "public"."capacitacion_bloques" TO "authenticated" USING (("private"."is_admin"() OR "private"."is_study_admin"())) WITH CHECK (("private"."is_admin"() OR "private"."is_study_admin"()));



ALTER TABLE "public"."cdeb_recommendations" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "channel_configs_select" ON "public"."channel_configs" FOR SELECT TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['comunicaciones'::"text"])));
...
CREATE POLICY "committee_goals_select" ON "public"."committee_goals" FOR SELECT TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['coordinador_servidores'::"text", 'lider_comite'::"text", 'direccion'::"text"])));
...
CREATE POLICY "duplicate_dismissals_all" ON "public"."duplicate_dismissals" TO "authenticated" USING ("private"."is_admin"()) WITH CHECK ("private"."is_admin"());
...
CREATE POLICY "event_exceptions_all" ON "public"."event_exceptions" TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['encargado_eventos'::"text", 'direccion'::"text"]))) WITH CHECK (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['encargado_eventos'::"text", 'direccion'::"text"])));
...
CREATE POLICY "event_organizing_committees_all" ON "public"."event_organizing_committees" TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['encargado_eventos'::"text", 'direccion'::"text"]))) WITH CHECK (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['encargado_eventos'::"text", 'direccion'::"text"])));
...
CREATE POLICY "family_members_select" ON "public"."family_members" FOR SELECT TO "authenticated" USING (("private"."is_admin"() OR "private"."is_own_member"("member_id") OR "private"."has_any_role"(ARRAY['editor_perfiles'::"text", 'encargado_staff'::"text", 'direccion'::"text"])));
...
CREATE POLICY "family_units_select" ON "public"."family_units" FOR SELECT TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['editor_perfiles'::"text", 'encargado_staff'::"text", 'direccion'::"text"]) OR (EXISTS ( SELECT 1
   FROM "public"."family_members" "fm"
  WHERE (("fm"."family_unit_id" = "family_units"."id") AND "private"."is_own_member"("fm"."member_id"))))));
...
CREATE POLICY "folleto_requests_all" ON "public"."folleto_requests" TO "authenticated" USING (("private"."is_admin"() OR "private"."is_study_admin"())) WITH CHECK (("private"."is_admin"() OR "private"."is_study_admin"()));
...
ALTER TABLE "public"."form_response_reviews" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "member_lists_select" ON "public"."member_lists" FOR SELECT TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['comunicaciones'::"text", 'direccion'::"text"])));
...
CREATE POLICY "member_role_position_grants_all" ON "public"."member_role_position_grants" TO "authenticated" USING ("private"."is_admin"()) WITH CHECK ("private"."is_admin"());
...
CREATE POLICY "position_requests_all" ON "public"."position_requests" TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['coordinador_servidores'::"text", 'encargado_staff'::"text", 'direccion'::"text"]))) WITH CHECK (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['coordinador_servidores'::"text", 'encargado_staff'::"text", 'direccion'::"text"])));



CREATE POLICY "premat_hist_select" ON "public"."prematrimonial_request_status_history" FOR SELECT TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['coordinador_estudios'::"text", 'coordinador_dirigentes'::"text", 'finanzas'::"text", 'direccion'::"text"])));



CREATE POLICY "premat_select" ON "public"."prematrimonial_requests" FOR SELECT TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['coordinador_estudios'::"text", 'coordinador_dirigentes'::"text", 'finanzas'::"text", 'direccion'::"text"]) OR "private"."is_own_member"("requester_member_id") OR "private"."is_own_member"("spouse_member_id")));



CREATE POLICY "premat_write" ON "public"."prematrimonial_requests" TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['coordinador_estudios'::"text", 'coordinador_dirigentes'::"text", 'finanzas'::"text", 'direccion'::"text"]))) WITH CHECK (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['coordinador_estudios'::"text", 'coordinador_dirigentes'::"text", 'finanzas'::"text", 'direccion'::"text"])));



ALTER TABLE "public"."prematrimonial_evaluations" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."prematrimonial_request_status_history" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."prematrimonial_requests" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "scholarship_redemptions_all" ON "public"."scholarship_redemptions" TO "authenticated" USING (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['finanzas'::"text", 'direccion'::"text"]))) WITH CHECK (("private"."is_admin"() OR "private"."has_any_role"(ARRAY['finanzas'::"text", 'direccion'::"text"])));
...
CREATE POLICY "study_invitations_all" ON "public"."study_invitations" TO "authenticated" USING (("private"."is_admin"() OR "private"."is_study_admin"())) WITH CHECK (("private"."is_admin"() OR "private"."is_study_admin"()));
...
CREATE POLICY "study_leaders_select" ON "public"."study_leaders" FOR SELECT TO "authenticated" USING (("private"."is_admin"() OR "private"."is_study_admin"() OR "private"."is_own_member"("member_id")));
...
CREATE POLICY "study_requirement_exceptions_all" ON "public"."study_requirement_exceptions" TO "authenticated" USING (("private"."is_admin"() OR "private"."is_study_admin"())) WITH CHECK (("private"."is_admin"() OR "private"."is_study_admin"()));
...
CREATE POLICY "vacancies_select" ON "public"."vacancies" FOR SELECT TO "authenticated" USING (true);
...
REVOKE ALL ON FUNCTION "public"."get_active_today"("p_oldest" timestamp with time zone, "p_min" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_active_today"("p_oldest" timestamp with time zone, "p_min" integer) TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_dm_flags"("p_oldest" timestamp with time zone, "p_recency" timestamp with time zone, "p_min" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_dm_flags"("p_oldest" timestamp with time zone, "p_recency" timestamp with time zone, "p_min" integer) TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_dm_milestones"("p_min" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_dm_milestones"("p_min" integer) TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_group_attendance"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_group_attendance"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."refresh_member_sede"("p_member_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."refresh_member_sede"("p_member_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."cdeb_recommendations" TO "authenticated";
GRANT ALL ON TABLE "public"."cdeb_recommendations" TO "service_role";
...
GRANT ALL ON TABLE "public"."form_response_reviews" TO "authenticated";
GRANT ALL ON TABLE "public"."form_response_reviews" TO "service_role";
...
GRANT ALL ON TABLE "public"."prematrimonial_evaluations" TO "authenticated";
GRANT ALL ON TABLE "public"."prematrimonial_evaluations" TO "service_role";



GRANT ALL ON TABLE "public"."prematrimonial_request_status_history" TO "authenticated";
GRANT ALL ON TABLE "public"."prematrimonial_request_status_history" TO "service_role";



GRANT ALL ON TABLE "public"."prematrimonial_requests" TO "authenticated";
GRANT ALL ON TABLE "public"."prematrimonial_requests" TO "service_role";
...
-- ─────────────────────────────────────────────────────────────────────────────
-- LO QUE `supabase db dump` NO TRAE (se dumpea solo `public`/`private`) y sí es
-- NUESTRO. Sin este bloque, un proyecto levantado desde cero con este baseline
-- perdería el espejo de confirmación de cuentas y los tres jobs de pg_cron.
-- (El baseline anterior, 20260718150236, ya tenía este hueco; se cierra acá.)
-- ─────────────────────────────────────────────────────────────────────────────

-- Espejo members.account_confirmed_at ← auth.users.email_confirmed_at (AUTH-1).
-- La FUNCIÓN sí viene en el volcado (vive en public); el TRIGGER va sobre
-- auth.users, que el dump excluye.
...
-- Jobs de pg_cron (los de la app viven en vercel.json; estos tres son de BD).
-- cron.schedule con el mismo jobname reemplaza el job existente.
SELECT "cron"."schedule"('refresh-donor-flags',  '30 6 * * *', 'SELECT refresh_donor_flags()');
SELECT "cron"."schedule"('refresh-member-sedes', '45 6 * * *', 'SELECT refresh_member_sedes()');
